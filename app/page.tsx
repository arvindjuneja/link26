...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-[#000102] text-white">
      <VfxThreeOverlay />
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1600px] flex-col gap-3 px-3 py-4">
        {/* Compact top bar */}
        <header className="flex items-center justify-between rounded border border-zinc-800 bg-black/60 px-4 py-2 text-[0.7rem]">
